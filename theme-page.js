...
const THEME_CONFIG = {
  hoofdthema1: {
    ...
    goals: [
      ...
      { id: 'landschap_d6', title: 'Doel 6 · Atlasopdracht met werkblad', development: true, themes: ['landschappen'], ovur: ['Lees het werkblad en markeer welke plaatsen of landschapselementen je moet opzoeken.', 'Neem je atlas, kies de juiste kaart (fysisch/politiek) en noteer de kaartlegende die je nodig hebt.', 'Zoek de gevraagde info in de atlas en vul de oefeningen op het werkblad stap voor stap in.', 'Controleer of elke oefening volledig is ingevuld en verbeter waar nodig met de atlas als bron.'] },
